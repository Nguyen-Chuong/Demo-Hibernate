...
public interface CertificateRepository extends JpaRepository<Certificate, Integer> {
    ...
    @Query("SELECT new com.example.demo.dto.CertificateDTO(c.id, c.certificateName, c.certificateRank, c.certificatedDate, c.employee.id) " +
            "FROM Certificate c WHERE c.employee.id = :id")
